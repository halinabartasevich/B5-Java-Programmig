...
public class ShorthandOperators {
    public static void main (String[] args){
        ...
        System.out.println(a);
        a = 100 + 10;   // this canNOT be converted to be used as SHORTHAND operator because SHORTHAND operator is when you add/minus/multi[/division/modules a value to ITSELF
        System.out.println();
